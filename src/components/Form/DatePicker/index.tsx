...
const DatePicker = React.forwardRef<RNDatePicker, Props>(
  (
    {
      date,
      label,
    ...
    const formattedDate = useMemo(() => {
      ...
      return moment(date).format(DATE_TIME_FORMAT.SHORT_DATE);
    }, [date]);
        ...
        <View style={GlobalStyles.container}>
          <TouchableOpacity
            ...
            <Paragraph
              ...
              title={formattedDate || placeholder || t('select_date')}
            />
          </TouchableOpacity>
        </View>
