...
type Props = NativeStackScreenProps<
  ...
  AppRoute.QUESTION_YOURSELF_STEP6
>;

const QuestionYourSelfStep6Screen = ({ navigation }: Props) => {
  ...
  const onNext = () => {
    navigation.navigate(AppRoute.QUESTION_YOURSELF_SUCCESS);
  };
  const onSkip = () => {
    navigation.navigate(AppRoute.QUESTION_YOURSELF_SUCCESS);
  };
      ...
      <View style={[GlobalStyles.container, GlobalStyles.mt10]}>
        <Paragraph
          ...
          title={t('impressive_for_you', {
            rank: t('the_place_other', { count: 6 }),
          })}
...
export default QuestionYourSelfStep6Screen;
